...
//
//    private fun extractEarthquakes(): ArrayList<Earthquake> {
//
...
//
//        try {
//            val rootJsonObject = JSONObject(SAMPLE_JSON_RESPONSE)
//            val featuresJsonArrayList = rootJsonObject.optJSONArray("features")
//
//            for (i in 0..featuresJsonArrayList!!.length()) {
//                val featuresJsonObject = featuresJsonArrayList.getJSONObject(i)
//
//                val propertiesJsonObject = featuresJsonObject.getJSONObject("properties")
//
//                val magnitude: Double = propertiesJsonObject.optDouble("mag")
//
//                var location = propertiesJsonObject.optString("place")
//
...
//                    indexValue = location.indexOf("the") + 2
//                    offset = location.substring(0, indexValue)
//                    location = location.substring(indexValue).trim()
//                }
//
//                val milliseconds: Long = propertiesJsonObject.optLong("time")
//
//                val url: String = propertiesJsonObject.optString("url")
//
//                earthquakes.add(Earthquake(magnitude, offset, location, milliseconds, url))
//            }
//        } catch (e: JSONException) {
//            Log.e(
//                "QueryUtils",
//                "Problem parsing the earthquake JSON results", e
//            )
//        }
//        return earthquakes
//    }
