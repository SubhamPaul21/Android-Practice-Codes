...
class ListAdapter(private val earthquakeList: List<Earthquake>) :
    ...
    override fun onBindViewHolder(holder: EarthquakeViewHolder, position: Int) {
        ...
        val magnitudeCircle: GradientDrawable = holderItem.magnitudeTextView.background as GradientDrawable
        holderItem.magnitudeTextView.text = earthquakeList[position].magnitude.toString()
        magnitudeCircle.setColor(ContextCompat.getColor(holderItem.context, getMagnitudeColor(earthquakeList[position].magnitude)))
