...
//                Log.d("propertiesJsonObject",String.valueOf(featuresJsonObject));
                ...
                String magnitude = String.valueOf(propertiesJsonObject.optDouble("mag"));
...
//                Log.d("location" + i, "extractEarthquakes: " + location);
                String[] arrOfLocationStr = location.split(",");
                if (location.contains(",")) {
                    location = arrOfLocationStr[1].trim();
                } else {
                    location = arrOfLocationStr[0];
                }
